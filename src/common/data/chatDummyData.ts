    ...
    messages: [
      {
        id: 6,
        message:
          "Ella, I'd like to finesse the night scenes before color grading.",
      },
    ],
    user: USERS.JOHN,
    isReply: true,
    ...
    messages: [
      {
        id: 3,
        message:
          "Aenean erat tellus, pretium sed venenatis ac, pulvinar quis odio.",
      },
      {
        id: 4,
  ...
  },
  {
    ...
    messages: [
      ...
      },
      {
        id: 5,
        message:
          "In lectus dolor, hendrerit dictum viverra vel, consectetur eu arcu.",
      },
    ],
    user: USERS.ELLA,
  },
    ...
    messages: [
      {
        id: 9,
        message:
          "Pellentesque a massa at magna laoreet luctus sed dignissim erat.",
      },
    ],
    user: USERS.SAM,
  },
