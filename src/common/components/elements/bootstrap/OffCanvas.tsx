...
import Portal from "@/common/components/layouts/Portal/Portal";
...
import { TOffCanvasPlacement } from "@/common/types/offCanvas-type";
...
>(({ tag = "h5", id, children, className = undefined, ...props }, ref) => {
  return (
    <TagWrapper
      tag={tag}
      ref={ref}
...
>(({ children, className = undefined, setOpen = undefined, ...props }, ref) => {
  return (
    // eslint-disable-next-line react/jsx-props-no-spreading
    <div
      ref={ref}
...
export const OffCanvasBody = forwardRef<HTMLDivElement, IOffCanvasBodyProps>(
  ({ tag = "div", children, className = undefined, ...props }, ref) => {
    return (
      <TagWrapper
        tag={tag}
        ref={ref}
