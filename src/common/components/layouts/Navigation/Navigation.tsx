...
import useEventOutside from "@/common/hooks/useEventOutside";
import { pathRetouch } from "@/common/helpers/helpers";
...
export const NavigationLine: FC<INavigationLineProps> = ({
  className = undefined,
}) => {
...
const Navigation = forwardRef<HTMLElement, INavigationProps>(
  ({ menu, horizontal = false, className = undefined, id, ...props }, ref) => {
