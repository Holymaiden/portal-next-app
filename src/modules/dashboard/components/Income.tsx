...
import Chart, {
  IChartOptions,
} from "@/common/components/elements/extras/Chart";
import Card, {
  CardActions,
  CardBody,
  CardHeader,
...
import { average, priceFormat } from "@/common/helpers/helpers";
import PercentComparison from "@/common/components/elements/extras/PercentComparison";
    ...
    <Card stretch>
      <CardHeader>
        <CardLabel icon="PointOfSale" iconColor="success">
          ...
          <CardSubTitle>Weekly</CardSubTitle>
        </CardLabel>
        <CardActions>
          <Dropdown>
            <DropdownToggle>
